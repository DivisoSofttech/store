...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "preordersettings")
public class PreOrderSettings implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PreOrderSettings)) {
            return false;
        }
        return id != null && id.equals(((PreOrderSettings) o).id);
    }

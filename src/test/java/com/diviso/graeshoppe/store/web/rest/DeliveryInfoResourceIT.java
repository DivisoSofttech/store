...
import com.diviso.graeshoppe.store.repository.DeliveryInfoRepository;
import com.diviso.graeshoppe.store.repository.search.DeliveryInfoSearchRepository;
...
import com.diviso.graeshoppe.store.service.mapper.DeliveryInfoMapper;
...
/**
 * Integration tests for the {@link DeliveryInfoResource} REST controller.
 */
@SpringBootTest(classes = {StoreApp.class, TestSecurityConfiguration.class})
public class DeliveryInfoResourceIT {
     ...
     *
     * @see com.diviso.graeshoppe.store.repository.search.DeliveryInfoSearchRepositoryMockConfiguration
     */
    @Autowired
     ...
     * if they test an entity which requires the current entity.
     */
    public static DeliveryInfo createUpdatedEntity(EntityManager em) {
        DeliveryInfo deliveryInfo = new DeliveryInfo()

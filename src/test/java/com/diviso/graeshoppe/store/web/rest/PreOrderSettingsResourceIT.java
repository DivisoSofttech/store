...
/**
 * Integration tests for the {@link PreOrderSettingsResource} REST controller.
 */
@SpringBootTest(classes = {StoreApp.class, TestSecurityConfiguration.class})
public class PreOrderSettingsResourceIT {
     ...
     *
     * @see com.diviso.graeshoppe.store.repository.search.PreOrderSettingsSearchRepositoryMockConfiguration
     */
    @Autowired
     ...
     * if they test an entity which requires the current entity.
     */
    public static PreOrderSettings createUpdatedEntity(EntityManager em) {
        PreOrderSettings preOrderSettings = new PreOrderSettings()

...
public class StoreResourceIT {
     ...
     *
     * @see com.diviso.graeshoppe.store.repository.search.StoreSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getStore() throws Exception {
        ...
        restStoreMockMvc.perform(get("/api/stores/{id}", store.getId()))
            ...
            .andExpect(jsonPath("$.storeUniqueId").value(DEFAULT_STORE_UNIQUE_ID))

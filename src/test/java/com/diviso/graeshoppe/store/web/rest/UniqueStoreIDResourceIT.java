...
import com.diviso.graeshoppe.store.repository.UniqueStoreIDRepository;
import com.diviso.graeshoppe.store.repository.search.UniqueStoreIDSearchRepository;
...
import com.diviso.graeshoppe.store.service.mapper.UniqueStoreIDMapper;
...
/**
 * Integration tests for the {@link UniqueStoreIDResource} REST controller.
 */
@SpringBootTest(classes = {StoreApp.class, TestSecurityConfiguration.class})
public class UniqueStoreIDResourceIT {
     ...
     *
     * @see com.diviso.graeshoppe.store.repository.search.UniqueStoreIDSearchRepositoryMockConfiguration
     */
    @Autowired
     ...
     * if they test an entity which requires the current entity.
     */
    public static UniqueStoreID createUpdatedEntity(EntityManager em) {
        UniqueStoreID uniqueStoreID = new UniqueStoreID();
        return uniqueStoreID;
    }
